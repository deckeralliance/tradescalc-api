...
class TestAmpacity:
    ...
    def test_copper_12awg_75c(self, client):
        ...
        response = client.post("/v1/electrical/ampacity", json={
            "wire_size": "12",
            "material": "copper",
            "temp_rating": "75"
        })
...
class TestVoltageDrop:
    ...
    def test_basic_voltage_drop_120v(self, client):
        ...
        """
        response = client.post("/v1/electrical/voltage-drop", json={
            "load_amps": 20,
            "distance_ft": 100,
            "wire_size": "12",
            "voltage": 120,
...
class TestConduitFill:
    ...
    def test_three_12awg_in_emt(self, client):
        ...
        """
        response = client.post("/v1/electrical/conduit-fill", json={
            "conductors": [
                {"wire_size": "12", "count": 3}
            ],
            "conduit_type": "emt"
        })
        assert response.status_code == 200
...
class TestBreakerSize:
    ...
    def test_continuous_load(self, client):
        ...
        response = client.post("/v1/electrical/breaker-size", json={
            "load_amps": 40,
            "continuous": True
        })
        assert response.status_code == 200
...
class TestTransformerSizing:
    ...
    def test_basic_transformer(self, client):
        ...
        response = client.post("/v1/electrical/transformer-sizing", json={
            "load_va": 24000,
            "voltage_primary": 480,
            "voltage_secondary": 208
        })
        assert response.status_code == 200
        data = response.json()
